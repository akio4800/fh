...
DROP TABLE Leistungseintrag CASCADE CONSTRAINTS PURGE;
DROP TABLE Taetigkeit CASCADE CONSTRAINTS PURGE;
...
(
	...
	Jahr		  DATE  NOT NULL ,
	PersonID	  INTEGER  NOT NULL ,
	von		  VARCHAR2(20)  NULL ,
	bis		  VARCHAR2(20)  NULL ,
	Tag		  INTEGER  NULL ,
...
CREATE UNIQUE INDEX XPKLeistungseintrag ON Leistungseintrag
(EintragID  ASC);



ALTER TABLE Leistungseintrag
	ADD CONSTRAINT  XPKLeistungseintrag PRIMARY KEY (EintragID,Monat,Jahr,PersonID);
...
CREATE UNIQUE INDEX XPKTaetigkeit ON Taetigkeit
(ID  ASC);
...
ALTER TABLE Leistungseintrag
	ADD (CONSTRAINT  R_20 FOREIGN KEY (Monat,Jahr,PersonID) REFERENCES Ag_PgProMonat(Monat,Jahr,PersonID));
